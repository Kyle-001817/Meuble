...
<% ArrayList listStyle = (ArrayList<Object>)request.getAttribute("listeStyle");%>
<% ArrayList listVolume = (ArrayList<Object>)request.getAttribute("listeVolume");%>
<% ArrayList listUnites = (ArrayList<Object>)request.getAttribute("listeUnites");%>
    <!-- Header Start -->
                    ...
                    <div class="col-md-10">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3 mb-md-0">
                                        <select class="custom-select px-4" name="unites" style="float: left; height: 47px; width: 500px; margin-top: 50px;">
                                            <option selected>Unites</option>
                                            <%for(int i=0; i<listUnites.size(); i++){%>
                                            <option value="<%out.print(((Unites)listUnites.get(i)).getId_unite());%>"><%out.print(((Unites)listUnites.get(i)).getNom());%></option>
                                            <% } %>
                                        </select>
                                    </div>
                                </div>                                      
